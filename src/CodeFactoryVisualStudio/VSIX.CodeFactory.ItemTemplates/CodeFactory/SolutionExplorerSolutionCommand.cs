...
namespace $rootnamespace$
{
    ...
    /// </summary>
    public class $safeitemrootname$:SolutionCommandBase
    {
        ...
        public override async Task<bool> EnableCommandAsync(VsSolution result)
        {
            ...
            {
                _logger.Error($"The following unhandled error occured while checking if the solution explorer solution command {commandTitle} is enabled. ",
                    unhandledError);
                isEnabled = false;
            }
        ...
        public override async Task ExecuteCommandAsync(VsSolution result)
        {
            ...
            {
                _logger.Error($"The following unhandled error occured while executing the solution explorer solution command {commandTitle}. ",
                    unhandledError);
