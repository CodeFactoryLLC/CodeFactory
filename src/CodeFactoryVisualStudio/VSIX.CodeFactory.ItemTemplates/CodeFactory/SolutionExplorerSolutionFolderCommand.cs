...
namespace $rootnamespace$
{
    ...
    public class $safeitemrootname$:SolutionFolderCommandBase
    {
        ...
        public override async Task<bool> EnableCommandAsync(VsSolutionFolder result)
        {
            ...
            {
                _logger.Error($"The following unhandled error occured while checking if the solution explorer solution folder command {commandTitle} is enabled. ",
                    unhandledError);
                isEnabled = false;
            }
        ...
        public override async Task ExecuteCommandAsync(VsSolutionFolder result)
        {
            ...
            {
                _logger.Error($"The following unhandled error occured while executing the solution explorer solution folder command {commandTitle}. ",
                    unhandledError);
