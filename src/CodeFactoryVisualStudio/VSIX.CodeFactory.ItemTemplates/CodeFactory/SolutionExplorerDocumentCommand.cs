...
namespace $rootnamespace$
{
    ...
    /// </summary>
    public class $safeitemrootname$:ProjectDocumentCommandBase
    {
        ...
        public override async Task<bool> EnableCommandAsync(VsDocument result)
        {
            ...
            {
                _logger.Error($"The following unhandled error occurred while checking if the solution explorer project document command {commandTitle} is enabled. ",
                    unhandledError);
                isEnabled = false;
            }
        ...
        public override async Task ExecuteCommandAsync(VsDocument result)
        {
            ...
            {
                _logger.Error($"The following unhandled error occurred while executing the solution explorer project document command {commandTitle}. ",
                    unhandledError);
