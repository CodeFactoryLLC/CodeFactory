...
{
    /// <summary>
    /// Code factory command for automation of a document that is managed under the solution when selected from solution explorer.
    /// </summary>
    public class $safeitemrootname$:SolutionDocumentCommandBase
    {
    ...
    #pragma warning disable CS1998
        ...
        #region Overrides of VsCommandBase<VsDocument>
